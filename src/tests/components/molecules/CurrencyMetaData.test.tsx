...
} from "src/components/molecules/CurrencyMetaData.component";
...
describe("CurrencyMetaData component", () => {
  const mockedFindIndexByCurrencyCode =
    findIndexByCurrencyCode as jest.MockedFunction<
  ...
  test("renders correctly with country information", () => {
    ...
    const countryNameElement = screen.getByText(
